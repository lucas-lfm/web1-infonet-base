...
const Details = ({ filme }) => {
  const { dados: videos } = useFetch(
    `${URL_FETCH}${filme.id}/videos?language=pt-BR`
  );
    ...
    <div className='details'>
      <div className='basic-info'>
        <img
          ...
          src={`${URL_IMG_BASE}${filme.poster_path}`}
          alt=''
        />
        ...
        <p>
          <img
            src={starIcon}
            alt='Ícone de estrela para indicar nota de avaliação'
          />{" "}
          <span>
